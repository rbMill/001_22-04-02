...
class SnapGridLayout(Layout):
    ...
    def _trigger_layout(self,widg,*args):
        # for i in dir(widg):
        #     try:
        #         attr = self.__getattribute__(i)
        #         if type(attr) not in [types.MethodType,types.BuiltinMethodType,types.MethodWrapperType]:
        #             print(f'{i} = {attr}')
    ...
    def add_widget(self, widget, *args, **kwargs):
        ...
        super(SnapGridLayout, self).add_widget(widget)
